...
// criando
router.post("/aluno", AlunoController.criar)  // passando o path e pegando a funçao de criar no controller

// pegando todos
router.get("/aluno", AlunoController.listarTodos ) // passando o path e pegando a funçao de listar todos no controller
...
// excluindo todos
router.delete("/aluno", AlunoController.excluirTodos) // passando o path e pegando a funçao de excluir todos no controller
